...
python main.py --mode train --config config/config_training.ini --save_path results/train_results/q_learning_transfer_trained.json --algo q_learning

------------------------------------------------------------------------------------------------------
# Bước 3: Chạy trên Target dùng model đã train
...
python main.py --mode target --config config/config_target.ini --save_path results/target_results/q_learning_transfer_final.json --load_path results/train_results/q_learning_transfer_trained.json --algo q_learning
